# -*- coding: utf-8 -*-
"""
@Created at 2021/3/3 14:16
@Author: Kurt
@file:NegtivePrice.py
@Desc:
"""
from tkinter import *
from main import *
...
class GUI(Frame):
    ...
    def plot_figures(self, V, gamma, P_HAT, DELTA_h, DELTA_l, CR, con):
        ...
        for current_c in np.arange(0, 1, 0.01):
            ...
            for p_current in np.arange(-1, 1, 0.005):
